...
export const SunIcon = ({ className, ...rest }) => (
  <svg
    ...
    viewBox="0 0 24 24"
    {...rest}
    className={`w-full h-auto sm:w-6 ${className}`}
  >
    <g
      fill="none"
      stroke="currentColor"
